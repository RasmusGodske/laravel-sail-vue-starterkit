...
```bash
sail composer require spatie/laravel-typescript-transformer
sail composer require spatie/enum
```
...
```bash
sail artisan vendor:publish --provider="Spatie\LaravelTypeScriptTransformer\TypeScriptTransformerServiceProvider"
```
